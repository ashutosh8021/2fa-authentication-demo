...
# This file shows how to use environment variables for security

import os

# SendGrid Configuration from Environment Variables
SENDGRID_API_KEY = os.getenv('SENDGRID_API_KEY', 'your-sendgrid-api-key-here')
SENDER_EMAIL = os.getenv('SENDER_EMAIL', 'your-verified-sender@yourdomain.com')
SENDER_NAME = os.getenv('SENDER_NAME', '2FA Demo App')

# Email Templates (same as config_sendgrid.py)
EMAIL_TEMPLATE_HTML = """
<!DOCTYPE html>
<html>
<head>
